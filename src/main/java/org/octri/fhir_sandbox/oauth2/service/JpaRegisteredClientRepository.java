...
/**
 * Implementation of the {@link RegisteredClientRepository} that uses the provided {@link ClientRepository} to persist
 * the data.
 *
...
public class JpaRegisteredClientRepository implements RegisteredClientRepository {
	...
	public RegisteredClient findByClientId(String clientId) {
		log.info("Finding client with client ID: {}", clientId);
		Assert.hasText(clientId, "clientId cannot be empty");
		return this.clientRepository.findByClientId(clientId).map(this::toObject).orElse(null);
	}

	private RegisteredClient toObject(Client client) {
		log.info("Converting client entity to RegisteredClient: {}", client);
	...
	private Client toEntity(RegisteredClient registeredClient) {
		log.info("Converting RegisteredClient to client entity: {}", registeredClient);
