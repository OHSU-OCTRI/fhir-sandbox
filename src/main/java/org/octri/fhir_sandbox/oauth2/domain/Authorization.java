...
/**
 * Entity representing an OAuth2 authorization, as defined by Spring Authorization Server.
 *
...
public class Authorization {
	...
	public String toString() {
		return "Authorization [id=" + id + ", registeredClientId=" + registeredClientId + ", principalName="
				...
				+ oidcIdTokenMetadata + ", oidcIdTokenClaims=" + oidcIdTokenClaims + ", userCodeValue=" + userCodeValue
				+ ", userCodeIssuedAt=" + userCodeIssuedAt + ", userCodeExpiresAt=" + userCodeExpiresAt
				+ ", userCodeMetadata=" + userCodeMetadata + ", deviceCodeValue=" + deviceCodeValue
				+ ", deviceCodeIssuedAt=" + deviceCodeIssuedAt + ", deviceCodeExpiresAt=" + deviceCodeExpiresAt
